...
* **Mudança de Escala no Tempo:** O sinal sofre compressão linear se o módulo do fator multiplicativo for maior que 1 ($|\alpha| > 1$) e expansão/extensão linear se for menor que 1 ($|\alpha| < 1$).
